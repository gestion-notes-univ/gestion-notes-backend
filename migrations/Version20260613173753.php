 ...
 */
final class Version20260613173753 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE deliberations (id UUID NOT NULL, moyenne_generale NUMERIC(4, 2) DEFAULT NULL, credits_valides INT DEFAULT 0 NOT NULL, decision VARCHAR(50) NOT NULL, date_deliberation TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, etudiant_id UUID DEFAULT NULL, semestre_id UUID DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE etudiants (id UUID NOT NULL, numero_etudiant VARCHAR(20) NOT NULL, annee_inscription INT NOT NULL, utilisateur_id UUID DEFAULT NULL, filiere_id UUID NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE notes (id UUID NOT NULL, note_cc NUMERIC(4, 2) DEFAULT NULL, note_examen NUMERIC(4, 2) DEFAULT NULL, note_finale NUMERIC(4, 2) DEFAULT NULL, validee BOOLEAN DEFAULT false NOT NULL, date_saisie TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, date_validation TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, commentaire TEXT DEFAULT NULL, etudiant_id UUID DEFAULT NULL, ue_id UUID DEFAULT NULL, validee_par UUID DEFAULT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_11BA68CDDEAB1A3 ON notes (etudiant_id)');
        $this->addSql('CREATE INDEX IDX_11BA68C62E883B1 ON notes (ue_id)');
        $this->addSql('CREATE INDEX IDX_11BA68C45A6BC42 ON notes (validee_par)');
        $this->addSql('CREATE TABLE notifications (id UUID NOT NULL, type_notif VARCHAR(100) NOT NULL, titre VARCHAR(200) NOT NULL, message TEXT NOT NULL, lue BOOLEAN DEFAULT false NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, destinataire_id UUID DEFAULT NULL, PRIMARY KEY (id))');
        $this->addSql('CREATE INDEX IDX_6000B0D3A4F84F6E ON notifications (destinataire_id)');
        $this->addSql('CREATE TABLE reclamations (id UUID NOT NULL, motif TEXT NOT NULL, statut VARCHAR(50) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, etudiant_id UUID DEFAULT NULL, note_id UUID DEFAULT NULL, traitee_par UUID DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE INDEX IDX_1CAD6B7647C244F1 ON reclamations (traitee_par)');
        ...
        $this->addSql('CREATE TABLE unites_enseignement (id UUID NOT NULL, nom VARCHAR(150) NOT NULL, code VARCHAR(20) NOT NULL, coefficient NUMERIC(4, 2) NOT NULL, credits_ects INT NOT NULL, note_minimum NUMERIC(4, 2) NOT NULL, semestre_id UUID DEFAULT NULL, enseignant_id UUID DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE utilisateurs (id UUID NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, email VARCHAR(180) NOT NULL, password_hash VARCHAR(255) NOT NULL, role VARCHAR(50) NOT NULL, actif BOOLEAN DEFAULT true NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('ALTER TABLE notes ADD CONSTRAINT FK_11BA68C62E883B1 FOREIGN KEY (ue_id) REFERENCES unites_enseignement (id) NOT DEFERRABLE');
        $this->addSql('ALTER TABLE notes ADD CONSTRAINT FK_11BA68C45A6BC42 FOREIGN KEY (validee_par) REFERENCES utilisateurs (id) ON DELETE CASCADE NOT DEFERRABLE');
        $this->addSql('ALTER TABLE notifications ADD CONSTRAINT FK_6000B0D3A4F84F6E FOREIGN KEY (destinataire_id) REFERENCES utilisateurs (id) ON DELETE CASCADE NOT DEFERRABLE');
        ...
        $this->addSql('ALTER TABLE reclamations ADD CONSTRAINT FK_1CAD6B7647C244F1 FOREIGN KEY (traitee_par) REFERENCES utilisateurs (id) ON DELETE CASCADE NOT DEFERRABLE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notes DROP CONSTRAINT FK_11BA68C62E883B1');
        $this->addSql('ALTER TABLE notes DROP CONSTRAINT FK_11BA68C45A6BC42');
        ...
        $this->addSql('ALTER TABLE reclamations DROP CONSTRAINT FK_1CAD6B7647C244F1');
